...
use sil14\VitrineBundle\Entity\Admin;
...
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $admins = $em->getRepository('VitrineBundle:Admin')->findAll();
    ...
    {
        $admin = new Admin();
        $form = $this->createForm('sil14\VitrineBundle\Form\AdminType', $admin);
    ...
    {
        $deleteForm = $this->createDeleteForm($admin);
        $editForm = $this->createForm('sil14\VitrineBundle\Form\AdminType', $admin);
